...
ActiveRecord::Schema.define(version: 2018_06_20_193607) do
  ...
  create_table "ingredients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipeingredient_id"], name: "index_ingredients_on_recipeingredient_id"
  end
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipeingredient_id"], name: "index_recipes_on_recipeingredient_id"
  end
